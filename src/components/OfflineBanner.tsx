...
export function OfflineBanner() {
  ...
  return (
    <div
      ...
      role="status"
      aria-live="polite"
      className="fixed top-0 left-0 right-0 z-[9999] bg-warning-light text-warning-foreground text-center px-4 py-2 text-sm font-medium border-b border-current"
    >
